...
$gam csv $csv gam update user "~Email" suspended off | tee -a /Users/Shared/feb2024-RIF.log

# Changing user's password to random
echo "-> Changing password to something random"
$gam csv $csv gam update user "~Email" password random | tee -a /Users/Shared/feb2024-RIF.log
...
$gam csv $csv gam user "~Email" deprovision | tee -a /Users/Shared/feb2024-RIF.log

# Removing user from all Groups
$gam csv $csv gam user "~Email" delete group | tee -a /Users/Shared/feb2024-RIF.log

# Removing recovery email and phone
echo "-> Removing recovery email and phone"
$gam csv $csv gam update user "~Email" recoveryemail "" recoveryphone "" | tee -a /Users/Shared/feb2024-RIF.log

echo "-> Setting force change password on next logon and then disabling immediately to expire current session"
$gam csv $csv gam update user "~Email" changepassword on | tee -a /Users/Shared/feb2024-RIF.log
sleep 2
$gam csv $csv gam update user "~Email" changepassword off | tee -a /Users/Shared/feb2024-RIF.log

# Mail forwarding
echo "Forwarding email"
$gam csv $csv gam user "~Email" add forwardingaddress "~forwardEmail" | tee -a /Users/Shared/feb2024-RIF.log
$gam csv $csv gam user "~Email" forward on "~forwardEmail" markread | tee -a /Users/Shared/feb2024-RIF.log

# Drive transferring
echo "-> Transfering Google Drive"
$gam csv $csv gam create datatransfer "~Email" gdrive "~driveEmail" privacy_level shared,private
echo "Drive transfer initiated" | tee -a /Users/Shared/feb2024-RIF.log
...
# Calendar delegate
$gam csv $csv gam calendar "~Email" add owner "~driveEmail" | tee -a /Users/Shared/feb2024-RIF.log
